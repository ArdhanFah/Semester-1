...
public class ContohTipeData02 {
    public static void main(String[] args) {
        ...
        System.out.println("Golongan dara\t\t\t\t\t\t: " + (byte) golonganDarah);
        System.out.println("Jarak\t\t\t\t\t\t\t\t: " + jarak);
        System.out.println("Jumlah pendudk dalam satu dusun\t:" + jumlahPendudukDalamSatuDusun);
        System.out.println("Suhu\t\t\t\t\t\t\t\t: " + suhu);
        System.out.println("Bert\t\t\t\t\t\t\t\t: " + (float) berat);
